...
const Login = () => {
    return (
        <div className="w-full max-w-md mx-auto p-4 rounded-md shadow sm:p-8 lg:my-20 md:my-32 bg-gray-900 text-gray-100">
	...
	<form novalidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
		...
		<button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-yellow-300 text-gray-900 text-lg hover:bg-zinc-700">Sign in</button>
	</form>
</div>
    );
};
